(() => {
  ...
  function placeEditorFirst() {
    ...
    if (editor.nextElementSibling !== inbox) inbox.parentNode.insertBefore(editor, inbox);
  }
  ...
  document.addEventListener('click', (event) => {
    ...
    // Let the native handler run first. If Android still shows no transition,
    // recover the new-capture form without touching stored records.
    window.setTimeout(() => {
