...
def main() -> None:
    ...
    for token in ['赛络纺纱', '赛络纱', '并捻纺', 'Siro spinning', 'Sirospun', 'サイロ紡績', 'サイロ糸']:
    ...
    require(aug, 'AB纱をSiroの別名にはしない', 'AB effect separation')
    ...
    siro_block = aug.split("id:'KC-SIRO-001'", 1)[1].split("id:'KC-SIRO-002'", 1)[0]
