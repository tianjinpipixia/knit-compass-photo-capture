...
def main() -> None:
    ...
    require(app_text, "uploadPortableManifest", "2.1.41 portable import")
    require(app_text, 'importedFrom: "PHOTO_CAPTURE_2_1_41_PORTABLE_ZIP"', "2.1.41 migration provenance")
